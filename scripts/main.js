...
const alternateRomanizations = {
  'AGUANG': ['aguang','china','a'],
  'ALTON ANG': ['alton','alton ang','malaysia','a'],
  'B': ['b', 'thai'],
  'BIANURA': ['bian', 'indonesia'],
  'DAVID': ['china','d'],
  'DONGDONG': ['china','d'],
  'DORN': ['thai','d'],
  'DUY': ['vietnam','d'],
  'EARTH': ['thai','e'],
  'GORDON': ['canada','g'],
  'GOU YI': ['gouyi','china','g'],
  'GUANMING': ['china','g'],
  'HIKARI': ['japan','h'],
  'HIKARU': ['japan','h'],
  'HONG JIN': ['hongjin', 'china','h'],
  'HU YETAO': ['tao', 'taotao','hu','yetao','china'],
  'IVAN': ['china',],
  'JACKSON': ['jack', 'malaysia','j'],
  'JELLY': ['china','j'],
  'JIAHAO': ['jia','china','j'],
  'JINGYU': ['jing','china','j'],
  'JUNHAN': ['jun', 'china', 'j'],
  'KAO': ['thai', 'k'],
  'KEVIN': ['xiaokaiwen', 'kaiwen', 'china','k'],
  'KK': ['yangkuangkuang','kuangkuang','k','china'],
  'KOHI': ['junghyun', 'korean', 'k'],
  'KOSHIN': ['japan', 'k'],
  'LIZI': ['luozhoubin', 'zhoubin','china','l'],
  'LU JUNXI': ['junxi', 'lu', 'china', 'l', 'j'],
  'LYU': ['l', 'japan', 'maison b'],
  'MYST': ['mystic','xuyisheng','usa','m'],
  'NINJA': ['thai','nin','n'],
  'OMAR': ['tang omar','tang','china','o','t']
};
